...
/*
	static DebugDraw = function(){
		var p1 ={ x: self.a.x, y: self.a.y, z: self.a.z};
		var p2 ={ x: self.b.x, y: self.b.y, z: self.b.z};
		var p3 ={ x: self.c.x, y: self.c.y, z: self.c.z};
		...
		vertex_add_point(vbuff, p1.x, p1.y, p1.z, nx, ny, nz, 0,0, c_red, 1);
		vertex_add_point(vbuff, p2.x, p2.y, p2.z, nx, ny, nz, 0,0, c_red, 1);
		vertex_add_point(vbuff, p3.x, p3.y, p3.z, nx, ny, nz, 0,0, c_red, 1);
		vertex_end(vbuff);	
